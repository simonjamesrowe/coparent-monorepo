        ...
        {calendarDays.map((day, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Custody indicator */}
              {day.custodyParent && (custodyPosition === 'start' || custodyPosition === 'single') && (
                <button
                  type="button"
                  onClick={(event) => {
                  ...
                  className="absolute top-1 right-1 rounded-full bg-white/80 px-2 py-0.5 text-[10px] font-medium text-slate-600 shadow-sm hover:bg-white"
                >
