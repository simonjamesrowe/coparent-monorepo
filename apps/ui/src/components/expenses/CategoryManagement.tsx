          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600 dark:text-slate-300">
                Standardize how expenses roll up into the family budget. Add custom categories to
                cover unique needs.
              </p>
            </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      {category.type === 'custom' ? 'Custom' : 'Predefined'}
                    </p>
                  </div>
                  <span
                    className={`rounded-full px-3 py-1 text-xs font-semibold ${colorClassMap[category.color] ?? colorClassMap.stone}`}
                  >
                    {category.color}
                  </span>
                </div>
