...
import type { Account, Statement, StatementLine, Category } from '../../types/expenses';

const formatCurrency = (value: number) => `$${value.toFixed(2)}`;

export interface StatementLineReviewProps {
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-slate-600 dark:text-slate-300">
                Quickly scan statement lines, tag child-related expenses, and flag approvals when
                required.
              </p>
            </div>
          ...
          <div className="divide-y divide-slate-100 dark:divide-slate-800">
            {lines.map((line) => {
              ...
              return (
                <div
                  key={line.id}
                  className="grid grid-cols-[1.4fr_2fr_1fr_1fr_1fr] items-center gap-3 py-4 text-sm"
                >
                  <div>
