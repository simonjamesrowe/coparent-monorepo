...
- **Standard Breakpoints**: Use Tailwind’s breakpoint system for consistency across the application
...
- **Responsive Utilities**: Use react-responsive for complex media-query logic that can't be expressed cleanly in Tailwind
