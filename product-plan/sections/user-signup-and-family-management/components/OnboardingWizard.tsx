...
export function OnboardingWizard({
  ...
  const familyInvitations = invitations.filter(
    (i) => i.familyId === activeFamilyId
  )
        ...
        <div className="bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl rounded-3xl border border-slate-200/60 dark:border-slate-700/60 shadow-2xl shadow-slate-200/40 dark:shadow-slate-950/50 overflow-hidden">
          ...
          {currentStep === 'child' && (
            <div className="p-8 sm:p-10">
                  ...
                  <div className="space-y-2">
                    {[...familyChildren, ...addedChildren].map((child, index) => (
                      ...
                      >
                        ...
                        <svg
                          className="w-5 h-5 text-teal-500 ml-auto"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                          strokeWidth={2}
              ...
              <div className="space-y-5 p-5 rounded-2xl bg-slate-50/70 dark:bg-slate-800/40 border border-slate-200/60 dark:border-slate-700/60">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                        Full access to manage schedules and family settings
                      </p>
                    </button>
                    <button
                      type="button"
                      onClick={() => setInviteRole('co-parent')}
                      className={`p-4 rounded-xl border-2 text-left transition ${
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                        Collaborate on schedules and view shared information
                      </p>
                    </button>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
                  <div className="flex gap-3">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                      You can skip this step and invite your co-parent later from
                      the Family Setup hub.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 flex justify-between">
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={goNext}
                    className="px-6 py-3 text-slate-600 dark:text-slate-300 font-medium rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition"
                  >
                    Skip for now
                  </button>
                  <button
          ...
          {currentStep === 'review' && (
            <div className="p-8 sm:p-10">
              ...
              <div className="space-y-4">
                ...
                <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
                  ...
                  <p className="text-lg font-semibold text-slate-900 dark:text-white">
                    {activeFamily?.name || familyName || 'Your Family'}
                  </p>
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    {activeFamily?.timeZone || timeZone}
                  </p>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-300 font-medium">
                      {familyChildren.length + addedChildren.length} added
                    </span>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {[...familyChildren, ...addedChildren].map((child, index) => (
                      <div
                        key={child.id || index}
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600"
                      >
                        <div className="w-6 h-6 rounded-md bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center text-white font-bold text-xs">
                          {child.fullName?.charAt(0)}
                        </div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {(pendingInvites.length > 0 || inviteEmail) ? (
                  ...
                  {pendingInvites.length > 0 ? (
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                      You can invite your co-parent later from the Family Setup hub.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="mt-10">
                <div className="p-5 rounded-2xl bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-teal-900/30 dark:to-emerald-900/20 border border-teal-200/60 dark:border-teal-800/40 mb-6">
                  <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-xl bg-white dark:bg-slate-800 shadow-lg flex items-center justify-center flex-shrink-0">
                      <svg
                        className="w-6 h-6 text-teal-600 dark:text-teal-400"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <div>
                      ...
                      <p className="text-sm text-teal-700 dark:text-teal-300 mt-1">
                        After completing setup, you'll access your Family Dashboard
                        where you can manage schedules, track expenses, and share
                        important information with your co-parent.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white font-bold rounded-xl shadow-xl shadow-teal-500/30 transition-all duration-200 hover:shadow-2xl hover:shadow-teal-500/40 hover:-translate-y-0.5 active:translate-y-0"
                  >
                    Complete Setup
                    <svg
                      className="w-5 h-5"
